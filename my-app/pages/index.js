...
export default function Home() {
	...
	return (
		...
		<Modal
			...
			<div className={styles.footer_content}><b style={{color:'#185c2b'}}>Green O - Sinh Tố Rau Sạch</b> là thương hiệu thức uống chú trọng đến các tiêu chí tươi, sạch, an toàn của nguyên liệu sử dụng nhằm đem lại lợi ích tốt nhất cho làn da và vóc dáng của bạn. Tự hào đem đến những sản phẩm an toàn và hiệu quả cao, góp phần tích cực trong việc cải thiện sắc vóc và sức khỏe người tiêu dùng Việt.
			<br/>
			<br/><br/>
			Cửa hàng chính: 416A1 Hai Bà Trưng, Phường Tân Định, Quận 1, TP. Hồ Chí Minh<br/>
			Chi Nhánh Hà Nội: Toà nhà Việt Đức Complex, 39 Lê Văn Lương, Phường Nhân Chính, Quận Thanh Xuân, Thành Phố Hà Nội<br/>
